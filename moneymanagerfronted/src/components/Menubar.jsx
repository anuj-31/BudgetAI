...
const Menubar = ({ activeMenu }) => {
    ...
    const handleLogout = () => {
        // Only clear user-related data, preserve income/expense data
    ...
    const renderAvatar = (sizeClass = "w-10 h-10") => (
        <span className={`${sizeClass} inline-flex items-center justify-center rounded-full bg-purple-100 text-sm font-semibold text-purple-700`}>
            {getInitial()}
        </span>
    );
